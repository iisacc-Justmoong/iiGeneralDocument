...
These first-party iisacc libraries are resolved as installed CMake packages rather than vendored into this repository. `iiHtmlBlock` depends on `iiXml`; iiGeneralDocument records both as direct public package dependencies.
