...
- core title, author, subject, description, keyword, creator, and modification
  metadata;
- paragraphs with style identifiers, alignment, and numbering identity/level;
...
- Each XML part is limited to 64 MiB by default. Override
  `maximumXmlPartBytes` only for a trusted document.
